...
const StyledPrivacyPolicy = styled.div`
  margin: ${props => (props.user ? 0 : props.theme.sizing.gap)};
`;
...
const PrivacyPolicy = props => {
  return (
    <StyledPrivacyPolicy {...props}>
      ...
      <Heading h1>Privacy Policy for Port Activity</Heading>

      <Paragraph>
        At Port Activity, accessible from https://portactivity.se, one of our main priorities is the privacy of our
        visitors. This Privacy Policy document contains types of information that is collected and recorded by Port
        Activity and how we use it.
      </Paragraph>
      ...
      <Paragraph>
        ...
        to the information that they shared and/or collect in Port Activity. This policy is not applicable to any
        information collected offline or via channels other than this website.
      </Paragraph>

      <Heading h2>Consent</Heading>

      <Paragraph>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</Paragraph>

      <Heading h2>Information we collect</Heading>
      ...
      <Heading h2>How we use your information</Heading>
      ...
      <Heading h2>Log Files</Heading>

      <Paragraph>
        Port Activity follows a standard procedure of using log files. These files log visitors when they visit
      ...
      <Heading h2>Cookies and Web Beacons</Heading>

      <Paragraph>
        Like any other website, Port Activity uses &apos;cookies&apos;. These cookies are used to store information
      ...
      <Heading h2>Advertising Partners Privacy Policies</Heading>

      <Paragraph>
        You may consult this list to find the Privacy Policy for each of the advertising partners of Port Activity.
      </Paragraph>

      <Paragraph>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on Port Activity, which are sent directly to
      ...
      <Paragraph>
        Note that Port Activity has no access to or control over these cookies that are used by third-party advertisers.
      </Paragraph>

      <Heading h2>Third Party Privacy Policies</Heading>

      <Paragraph>
        Port Activity&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
      ...
      <Heading h2>CCPA Privacy Rights (Do Not Sell My Personal Information)</Heading>
      ...
      <Heading h2>GDPR Data Protection Rights</Heading>
      ...
      <Heading h2>Children&apos;s Information</Heading>
      ...
      <Paragraph>
        Port Activity does not knowingly collect any Personal Identifiable Information from children under the age of
